...
O projeto apresenta o sistema *MarketOfConstruction*, uma aplicação desenvolvida em Java seguindo o padrão arquitetural MVC (Model-View-Controller). O objetivo é gerenciar um mercado de construções, permitindo o cadastro de produtos, gestão de usuários e registro de vendas. O sistema utiliza interface gráfica Swing e persistência de dados via JDBC com MySQL.
...
1. Clone o repositório:
   ```bash
   git clone [https://github.com/lucas04zx/marketofconstruction.git](https://github.com/lucas04zx/marketofconstruction.git)
